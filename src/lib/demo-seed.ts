...
const BOOK = [
  { firstName: "Dana", lastName: "Whitfield", email: "dana@example.com", companyName: "Whitfield Roofing", jobTitle: "Owner", birth: 3, born: 47, anniv: 40, spouse: "Marcus", hometown: "Tulsa, OK", team: "Kansas City Chiefs", kids: ["Ella (12)", "Owen (9)"], policy: 34, policyType: "Commercial auto", tier: "A" },
  ...
  { firstName: "Priya", lastName: "Raman", email: "priya@example.com", companyName: "Raman Dental Group", jobTitle: "Managing Partner", birth: 14, born: 41, anniv: 6, spouse: "Arjun", hometown: "Edison, NJ", team: "New York Knicks", kids: [], home: 6, homeDay: 8, customDate: "Practice anniversary", customDay: 26, tier: "C" },
  ...
  { firstName: "Aisha", lastName: "Bell", email: "aisha@example.com", companyName: "Bell Family Insurance", jobTitle: "Agency Principal", birth: 2, born: 39, anniv: 33, spouse: "Devon", hometown: "Atlanta, GA", team: "Atlanta Braves", kids: ["Zoe (5)"], closed: 1, closedDay: 2, tier: "A" },
  ...
  { firstName: "Janet", lastName: "Kowalski", email: "janet@example.com", companyName: "Kowalski Title Co", jobTitle: "Owner", birth: 25, born: 55, anniv: 150, spouse: "Ed", hometown: "Chicago, IL", team: "Chicago Bears", kids: ["Nick (26)"], home: 9, homeDay: 23, tier: "C" },
  { firstName: "Sam", lastName: "Nakamura", email: "sam.n@example.com", companyName: "Nakamura Electric", jobTitle: "Master Electrician", birth: 17, born: 38, anniv: 55, spouse: "Jess", hometown: "Portland, OR", team: "Portland Trail Blazers", kids: ["Kai (3)"], closed: 5, closedDay: 31, customDate: "Shop opened", customDay: 13, tier: "C" },
]
