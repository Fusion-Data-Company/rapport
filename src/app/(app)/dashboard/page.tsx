      ...
      <div className="grid grid-cols-3 gap-5">
          ...
          <GlassCard className="p-5 h-full">
            ...
            {todaySends.length === 0 ? (
              ...
              <div className="space-y-2">
                {todaySends.slice(0, 8).map((send: ScheduleItem) => (
        ...
        <div>
          <GlassCard className="p-5 h-full">
            ...
            <div className="space-y-2">
              {upcoming.slice(0, 10).map((item: ScheduleItem) => (
                <div key={item.id ?? `${item.contactId}-${item.occasionType}-${item.scheduledDate}`} className="flex items-start gap-2.5 py-2 border-b border-[var(--surface-border)] last:border-0">
