...
export default function Privacy() {
  return (
    <LegalShell kicker="Legal" title="Privacy policy">
      ...
      <p>Customers, who use Rapport, and contacts, the clients in a customer&rsquo;s book. Contacts never sign up for anything; their details come from the customer, who is responsible for them.</p>
      <h2>What a customer&rsquo;s account holds</h2>
      ...
      <p>Write and send the customer&rsquo;s notes, show the schedule and send log, bill the customer, and support them. The AI provider receives the parts of a profile needed to write one note (first name, the occasion, and the details you chose to keep) and nothing else. Nothing is sold, shared for advertising, or used to train models by us.</p>
      ...
      <h2>Processors</h2>
      <p>Clerk (sign-in), Stripe (billing), Neon (database), Vercel (hosting), the customer&rsquo;s own mailbox provider (sending), and the AI provider the customer chose or OpenRouter by default. Each acts under its own policy.</p>
      <h2>Cookies</h2>
