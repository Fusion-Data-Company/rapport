...
export default function Terms() {
  return (
    <LegalShell kicker="Legal" title="Terms of service">
      ...
      <p>Rapport keeps a profile on each of your clients, watches the dates that matter to your book (policy renewals, loan and home anniversaries, months since a closing, birthdays, wedding anniversaries, children&apos;s birthdays and any date you add), has an AI write a short note per person, and sends it from your own mailbox. It is operated by {VENDOR.name}, {VENDOR.address}.</p>
      <h2>Plan and billing</h2>
      <p>$39 per seat per month after a 14-day free trial, covering up to 1,000 contacts on one seat and 5,000 on two. The contact figure is a soft limit: going over it never blocks a contact or an import, it only tells you where the book stands. Your card is charged when the trial ends and monthly after that, through Stripe. Add or remove seats and cancel any time from Settings, Billing; the plan runs to the end of the paid period. When a trial ends without a card, or a payment fails, Rapport stops sending until billing is fixed. Refunds are in the <a href="/refunds">refund policy</a>.</p>
      ...
      <p>Each note is drafted by a language model from the profile you keep and from the interaction history recorded against that contact. Every note is held for your approval by default; you can switch that off in Settings, Timing and review, in which case only the first batch is held. Read the first batch. If a note is wrong or unwelcome, the schedule shows every note and you can add a topic to a contact&apos;s &quot;avoid&quot; list. You are responsible for what goes out under your name.</p>
