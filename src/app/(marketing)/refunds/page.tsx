...
export default function Refunds() {
  return (
    <LegalShell kicker="Legal" title="Refund policy">
      ...
      <p>If Rapport did not send a single note in your first paid month because of something on our side (the schedule shows &ldquo;failed&rdquo; with a reason that is ours, not your mailbox), email {VENDOR.email} and the month is refunded in full.</p>
      <h2>After that</h2>
